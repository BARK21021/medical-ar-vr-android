...
class VideoDataManager:
    def __init__(self):
        ...
        self.source_path = os.path.join(self.base_path, "assets", "source")
                ...
                "video_segments": [
                    {
                        ...
                        "explanation": "二尖瓣分为前叶(A)和后叶(P)，各分为三个区段：A1/A2/A3 和 P1/P2/P3。",
                    ...
                    },
                    {
                        ...
                        "image": os.path.join(self.source_path, "1.3.png"),
                    },
                ],
            },
            {
                ...
                "video_segments": [
                    ...
                    },
                    {
                        ...
                        "image": os.path.join(self.source_path, "2.2.png"),
                    },
                ],
            },
            {
                ...
                "video_segments": [
                    ...
                    },
                    {
                        ...
                        "image": os.path.join(self.source_path, "3.2.png"),
                    },
                ],
            },
        ]
